...
export const TimerIcon = (props: IconProps) => (
  <svg viewBox="0 0 24 24" {...props}>
    <g id="_icons">
      <path d="M19.3,7.7C19.5,7.9,19.7,8,20,8s0.5-0.1,0.7-0.3c0.4-0.4,0.4-1,0-1.4l-2-2c-0.4-0.4-1-0.4-1.4,0s-0.4,1,0,1.4L17.6,6   l-0.7,0.7c-1.1-0.9-2.4-1.4-3.9-1.6V4c0-0.6-0.4-1-1-1s-1,0.4-1,1v1.1C7.1,5.6,4,8.9,4,13c0,4.4,3.6,8,8,8s8-3.6,8-8   c0-1.8-0.6-3.5-1.7-4.9L19,7.4L19.3,7.7z M12,19c-3.3,0-6-2.7-6-6s2.7-6,6-6s6,2.7,6,6S15.3,19,12,19z" />
